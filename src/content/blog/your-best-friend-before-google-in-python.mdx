...
categories: ["python", "tips-and-tricks"]
---
...
![Screenshot of Python interactive shell showing the help utility in action.](/images/python-help-utility-terminal-screenshot.png)
