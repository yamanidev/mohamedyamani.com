...
categories: ["html", "web-development", "basics"]
---
...
![Screenshot of a simple HTML page with a main heading and a paragraph of text.](/images/example-html-page-screenshot.png)
