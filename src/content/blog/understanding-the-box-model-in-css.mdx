...
categories: ["css", "web-development", "basics"]
---
...
![Box model diagram](/images/css-box-model-diagram.png)
...
![box model in developer tools of previous example](/images/box-sizing-content-box-representation.png)
...
![box model in developer tools for border-box](/images/box-sizing-border-box-representation.png)
